...
#     --peak_pick_num $peak_pick_num > ../logs/Honey_neg_${method_variant}_${current_datetime}.log 2>&1 &
...
for peak_pick_num in ${peak_pick_num_list[@]}; do
    ...
    nohup python -u ../src/main2.py \
        ...
        --seed $seed \
        --method_variant $method_variant \
        --peak_pick_num $peak_pick_num > ../logs/Honey_neg_${method_variant}_top${peak_pick_num}_${current_datetime}.log 2>&1 &
    wait
done